...
const PAIRS = [
  ...
  // --accent-vivid is display type, icons and decoration only, so 3:1 is the
  // bar it has to clear — never body text, never a white label on a fill.
  ['Vivid accent (display type) on page', 'accent-vivid', 'bg', 3.0],
  ['Vivid accent (display type) on card', 'accent-vivid', 'surface', 3.0],
  ['Vivid accent icon on raised surface', 'accent-vivid', 'surface-raised', 3.0],
