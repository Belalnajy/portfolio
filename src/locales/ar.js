...
const ar = {
    translation: {
      ...
      projects: {
        ...
        items: {
          opptmakers: {
            impact: 'صلاحيات محددة لكل موظف',
            title: 'صناع الفرص — نظام إدارة العملاء والمعاملات',
            desc: 'منصة داخلية لشركة سعودية متخصصة في تأسيس الشركات للمستثمرين الأجانب. بتدير ملفات العملاء وبتتابع كل معاملة تأسيس خطوة بخطوة، بصلاحيات محددة لكل موظف بحيث ميوصلش غير للمعاملات المسموح له بيها. عربية بالكامل ومبنية على RTL.',
            features: [
              'إدارة العملاء والمعاملات الخاصة بتأسيس الشركات',
              'متابعة كل معاملة خطوة بخطوة من أول طلب لحد تسليم الأوراق',
              'صلاحيات محددة لكل موظف',
              'واجهة عربية بالكامل بدعم RTL',
              'وضع فاتح ووضع داكن',
              'Next.js و React في الواجهة، و NestJS و PostgreSQL في الخلفية، و Tailwind CSS في التصميم'
            ]
          },
          bilqalam: {
      ...
      timeline: {
        ...
        items: [
          ...
          },
          {
            ...
            company: 'شركة صناع الفرص (السعودية)',
            location: 'عن بُعد، المملكة العربية السعودية',
            period: '07/2026 - الحالي',
            employment: 'دوام جزئي',
            description: [
              'بناء منصة إدارة العملاء والمعاملات الداخلية لشركة متخصصة في تأسيس الشركات للمستثمرين الأجانب في السعودية',
              'واجهة عربية بالكامل بدعم RTL مع صلاحيات محددة لكل موظف',
              'متابعة كل معاملة تأسيس خطوة بخطوة من أول طلب لحد تسليم الأوراق',
              'Next.js و React في الواجهة، و NestJS و PostgreSQL في الخلفية، و Tailwind CSS في التصميم'
            ]
          },
          {
          ...
          },
          {
            ...
            employment: 'عقد مؤقت',
            description: [
              'تدريس تطوير واجهات المواقع (HTML, CSS, JavaScript) لأكثر من 440 طالباً',
      ...
      now_page: {
        title: 'الآن',
        subtitle: 'اللي مركّز فيه الفترة دي — بيتحدث كل ما الدنيا تتغير.',
        updated: 'آخر تحديث: سبتمبر 2026',
        focus_title: 'شغال على',
        focus: [
          'مهندس برمجيات في ezSec Inc (كندا، عن بُعد): بناء وتسليم برمجيات أمن سيبراني، وجزء الـ DevOps — نشر الإصدارات على سيرفرات الإنتاج وضمان استمرارها',
          'Indstrz، منصة المشتريات الصناعية B2B اللي شاركت في تأسيسها: دورات الـ RFQ ومحرك التفاوض اللحظي',
          'مشاريع فريلانس لعملاء مصر والخليج، بتركيز على المنصات العربية أولاً',
        ],
        learning_title: 'بطوّر في',
        learning: [
          'ممارسات هندسة الأمان من الشغل جوه شركة أمن سيبراني',
          'بنية الإنتاج التحتية: خطوط النشر وتشغيل السيرفرات والمراقبة',
          'أساليب التطوير بمساعدة الـ AI، مع انضباط في المراجعة',
        ],
      ...
      rtl_demo: {
        label: 'تجربة حية',
        title: 'إيه اللي بيتكسر فعلاً في العربي',
        subtitle: 'قلب صفحة هبوط لـ RTL سهل. دي فاتورة — جدول، وكود منتج بحروف لاتينية، وعملة مع رقم. غيّر الاتجاه، وبعدين غيّر طريقة المعالجة، وشوف أربع مشاكل حقيقية بتظهر وتختفي.',
        direction: 'الاتجاه',
        treatment: 'المعالجة',
        naive: 'قلب ساذج',
        correct: 'معالجة صحيحة',
        breaking: 'أربع حاجات غلط دلوقتي',
        holding: 'الأربعة سليمين',
        checks: {
          alignment: {
            title: 'المحاذاة بتتبع القارئ',
            broken: 'text-align: left اتجاه فيزيائي، فالتخطيط بعد ما اتقلب فضل نصه ملزوق في الناحية القديمة.',
            fixed: 'الخصائص المنطقية (text-start / text-end) بتتبع الاتجاه، فملف ستايل واحد بيخدم الاتجاهين.'
          },
          icons: {
            title: 'الأيقونات الاتجاهية بتنعكس',
            broken: 'سهم «التالي» لسه مأشر يمين، واللي في ترتيب القراءة العربي معناه «رجوع».',
            fixed: 'الأيقونات اللي بتحمل اتجاه بتتعكس، واللوجوهات وأزرار التشغيل بتفضل زي ما هي.'
          },
          bidi: {
            title: 'النصوص الأجنبية بتفضل زي ما هي',
            broken: 'الكمية وكود المنتج بيقعوا جنب بعض وبيتقروا كأنهم كلمة واحدة — 12OIL-4471 — لأن مفيش عزل لأي واحد فيهم.',
            fixed: 'وسم <bdi> بيعزل كل نص أجنبي لوحده، فالكود والرقم بيفضلوا منفصلين ومقروئين.'
          },
          numerals: {
            title: 'الأرقام بتتقري كأرقام',
            broken: 'الأعمدة بتنعكس بس المحاذاة لأ، فعمود السعر بيفضل معلق على الحافة الغلط من الجدول.',
            fixed: 'خلايا الأرقام اتجاهها LTR صراحةً وبخط جدولي، فالأرقام والعلامة العشرية مابيتحركوش.'
          }
        },
        sample_note: 'بيانات تجريبية — فاتورة قطع غيار، مش قائمة أسعار.',
        footnote: 'دي نفس المعالجة اللي بتدخل في لوحات التحكم والفواتير والتقارير في كل مشروع بسلّمه — مش في صفحة الهبوط بس.'
      },
      uses: {
        title: 'أدواتي',
        subtitle: 'الأدوات اللي بفتحها فعلاً كل يوم — مش قائمة أمنيات.',
        groups: [
          {
            heading: 'المحرر والتيرمينال',
            items: [
              'VS Code باختصارات Vim وثيم داكن قريب من ثيم الموقع ده',
              'Zsh على لينكس، و tmux للجلسات الطويلة',
              'Git من سطر الأوامر، و GitHub للمراجعة والـ CI'
            ]
          },
          {
            heading: 'البناء',
            items: [
              'Next.js و React لأي حاجة ليها واجهة',
              'Django و Laravel للمنصات اللي بتشيل فلوس واعتمادات',
              'NestJS و Express لما خدمة Node تبقى أنسب للفريق',
              'Tailwind CSS بتوكنز تصميم مش قيم خام'
            ]
          },
          {
            heading: 'البيانات والبنية التحتية',
            items: [
              'PostgreSQL كخيار افتراضي، و MongoDB لما المستندات تبقى فعلاً مناسبة',
              'Redis و Celery للمهام الخلفية والمجدولة',
              'Docker عشان جهازي والإنتاج يبقوا زي بعض',
              'Nginx على VPS لينكس، أو Vercel لما شكل المشروع يسمح'
            ]
          },
          {
            heading: 'طريقة الشغل',
            items: [
              'Notion للمواصفات ونطاق العمل مع العميل',
              'Trello لمتابعة المراحل في المشاريع محددة النطاق',
              'Figma لقراءة التصميمات — بس ببني من التوكنز مش من الصور',
              'واتساب للتواصل مع العملاء — ده اللي عملاء الخليج بيردوا عليه فعلاً'
            ]
          }
        ],
        note: 'الصفحة دي بتتغير مع تغير الشغل. لو في حاجة هنا قديمة يبقى الموقع غلط وحابب أعرف.'
      },
      testimonials_page: {
        title: 'آراء العملاء',
        subtitle: 'كل التقييمات كاملة، من منصات العمل الحر اللي بشتغل من خلالها.'
      },
      privacy: {
        title: 'الخصوصية',
        subtitle: 'إيه اللي الموقع بيجمعه، وإيه اللي مابيجمعوش، ومين كمان بيشوفه.',
        updated: 'آخر تحديث: سبتمبر ٢٠٢٦',
        sections: [
          {
            heading: 'باختصار',
            body: 'ده معرض أعمال مش منتج. مفيش حساب تعمله، ولا كوكيز تتبع، ولا شبكة إعلانات، ومفيش أي بيانات بتتباع أو تتشارك. البيانات الشخصية الوحيدة اللي بتوصلني هي اللي بتكتبها في فورم التواصل أو بتبعتها على واتساب.'
          },
          {
            heading: 'فورم التواصل',
            body: 'الفورم بيبعت اسمك وإيميلك ورسالتك على بريدي مباشرة عن طريق EmailJS، اللي بيوصّلها ومابيستخدمهاش في أي حاجة تانية. بحتفظ بالإيميل عشان أقدر أرد وعشان يبقى عندي سجل للمحادثة. ومابضيفكش لأي قائمة بريدية.'
          },
          {
            heading: 'واتساب',
            body: 'زرار الواتساب بيفتح محادثة في الواتساب بتاعك برسالة مكتوبة جاهزة. مفيش حاجة بتتبعت غير لما أنت تبعتها، والمحادثة بتفضل في واتساب تحت شروطهم مش شروطي.'
          },
          {
            heading: 'التحليلات',
            body: 'Vercel Web Analytics بيعد الزيارات وكام إجراء — ضغطة واتساب، تحميل سيرة ذاتية، فتح دراسة حالة — عشان أعرف أنهي أجزاء الموقع مفيدة. من غير كوكيز ومجمّع: بيسجل إن حاجة حصلت، مش مين عملها. مفيش تسجيل جلسات ولا خرائط حرارية ولا ملف تعريف عبر المواقع.'
          },
          {
            heading: 'اللي بيفضل في متصفحك',
            body: 'اختيارك للغة وللوضع الفاتح/الداكن بيتخزن في localStorage بتاع الموقع نفسه عشان الزيارة الجاية تبقى زي ما سبتها. مابيخرجش من جهازك ومش بقدر أقراه. ومسح بيانات الموقع بيشيله.'
          },
          {
            heading: 'الاستضافة',
            body: 'الموقع شغال على Vercel، اللي بيعالج بيانات الطلب المعتادة زي عنوان الـ IP والمتصفح عشان يقدّم الصفحات ويحمي من إساءة الاستخدام. والخطوط بتيجي من Google Fonts.'
          },
          {
            heading: 'حقوقك',
            body: 'تقدر تسألني إيه اللي عندي عنك، أو تطلب نسخة، أو تطلب إني أمسحه — بالإيميل، في أي وقت، وهنفّذ. وبما إن السجل الوحيد عادةً هو محادثة إيميل، فمسحه فعلاً هو مجرد مسحه.'
          }
        ],
        contact_line: 'أي سؤال عن ده: {{email}}'
      },
      cv: {
        title: 'السيرة الذاتية',
        subtitle: 'نفس معلومات الموقع، في صفحة واحدة قابلة للطباعة.',
        download: 'تحميل PDF',
        print: 'طباعة',
        ...
        highlights: {
          delivered: '{{projects}}+ مشروعاً لـ {{clients}}+ عميلاً في مصر والخليج',
          reviews: '100% تقييمات إيجابية من العملاء على خمسات ونفذلي',
          teaching: 'تدريس تطوير الواجهات لأكثر من {{students}} طالباً في ITI',
          rtl: 'دعم العربية و RTL في كل مشروع، بما فيها الواجهات المالية والمليانة بيانات'
        },
        spoken_languages_label: 'اللغات',
        spoken_languages: 'العربية (لغة أم) · الإنجليزية (احترافية)'
      },
      theme: {
